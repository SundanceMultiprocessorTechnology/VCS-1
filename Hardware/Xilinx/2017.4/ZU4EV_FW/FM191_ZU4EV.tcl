...
create_project FM191_ZU4EV <path>/FM191-ZU4EV_FW/FM191_ZU4EV -part xczu4ev-sfvc784-1-e
...
set_property  ip_repo_paths  <path>/FM191-ZU4EV_FW/IP_Repo [current_project]
update_ip_catalog
...
set_property -dict [list CONFIG.NUM_PORTS {4}] [get_bd_cells UART_INT]
...
connect_bd_net [get_bd_pins FMC_I2C/iic2intc_irpt] [get_bd_pins UART_INT/In3]
connect_bd_net [get_bd_pins UART_INT/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
...
#Create VHDL wrapper
make_wrapper -files [get_files <path>/FM191-ZU4EV_FW/FM191_ZU4EV/FM191_ZU4EV.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse <path>/FM191-ZU4EV_FW/FM191_ZU4EV/FM191_ZU4EV.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd

#Add constraints file
add_files -fileset constrs_1 -norecurse <path>/FM191-ZU4EV_FW/FM191_ZU4EV.xdc
...
#Export .hdf and .bit
file mkdir <path>/FM191-ZU4EV_FW/FM191_ZU4EV/FM191_ZU4EV.sdk
file copy -force <path>/FM191-ZU4EV_FW/FM191_ZU4EV/FM191_ZU4EV.runs/impl_1/design_1_wrapper.sysdef <path>/FM191-ZU4EV_FW/FM191_ZU4EV/FM191_ZU4EV.sdk/design_1_wrapper.hdf
