...
# Engineer:       Pedro Machado
# Design Name:    FM191_RPI_ZU4EV
# Tool Versions:  Vivado 19.2
################################################################################################

#Use script's path as project's path
set script_path [file dirname [file normalize [info script]]]

#Create project for FM191_RPI_ZU4EV
create_project FM191_RPI_ZU4EV $script_path/FM191_RPI_ZU4EV -part xcZU4EV-sfvc784-1-e
...
set_property board_connections {fmc_lpc_connector sundance:fm191-ru_rpi:fmc_lpc_connector:1.0} [current_project]
...
set_property -dict [list CONFIG.PSU__USE__IRQ0 {1} CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__FREQMHZ {20} CONFIG.PSU__SPI1__PERIPHERAL__ENABLE {1} CONFIG.PSU__SPI1__PERIPHERAL__IO {EMIO} CONFIG.PSU__SATA__PERIPHERAL__ENABLE {1} CONFIG.PSU__I2C0__PERIPHERAL__IO {MIO 38 .. 39}] [get_bd_cells zynq_ultra_ps_e_0]
...
startgroup
set_property -dict [list CONFIG.NUM_SI {2} CONFIG.NUM_MI {14} CONFIG.NUM_MI {14}] [get_bd_cells ps8_0_axi_periph]
endgroup
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ps8_0_axi_periph/M11_AXI] [get_bd_intf_pins axi_vdma_0/S_AXI_LITE]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ps8_0_axi_periph/M12_AXI] [get_bd_intf_pins v_tc_0/ctrl]
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ps8_0_axi_periph/M13_AXI] [get_bd_intf_pins v_tpg_0/s_axi_CTRL]
...
connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins ps8_0_axi_periph/M13_ACLK]
...
connect_bd_net [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M11_ARESETN]
connect_bd_net [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M12_ARESETN]
...
connect_bd_net [get_bd_pins rst_ps8_0_75M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M13_ARESETN]
...
#----------------------------------------------------------------------------------#
# Adding DPU support. Comment out this part of the script if not required  # BEGIN #
#----------------------------------------------------------------------------------#
...
#Modify Interrupts from HDMI concat, to add interrupts for DPU
startgroup
...
#----------------------------------------------------------------------------------#
# Adding DPU support. Comment out this part of the script if not required  #  END  #
#----------------------------------------------------------------------------------#
...
#Create VHDL wrapper
make_wrapper -files [get_files $script_path/FM191_RPI_ZU4EV/FM191_RPI_ZU4EV.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse $script_path/FM191_RPI_ZU4EV/FM191_RPI_ZU4EV.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd

#Add constraints file
add_files -fileset constrs_1 -norecurse $script_path/FM191_RPI_ZU4EV.xdc
...
#Export .hdf and .bit
file mkdir $script_path/FM191_RPI_ZU4EV/FM191_RPI_ZU4EV.sdk
file copy -force $script_path/FM191_RPI_ZU4EV/FM191_RPI_ZU4EV.runs/impl_1/design_1_wrapper.sysdef $script_path/FM191_RPI_ZU4EV/FM191_RPI_ZU4EV.sdk/design_1_wrapper.hdf
