...
source [file join [file dirname [file dirname [info script]]] gui/dpu_eu_v0_0_53.gtcl]
...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "S_AXI_CLK_INDEPENDENT" -parent ${Arch} -layout horizontal
  #Adding Group
  set IMPL [ipgui::add_group $IPINST -name "IMPL" -parent ${Arch} -display_name {Implementation}]
  ...
  ipgui::add_param $IPINST -name "IRQ_SUM" -parent ${Summary} -widget comboBox
...
proc update_PARAM_VALUE.BRAM_N { PARAM_VALUE.BRAM_N PARAM_VALUE.VER_DPU_NUM PARAM_VALUE.BBANK_IMG_N PARAM_VALUE.BBANK_WGT_N PARAM_VALUE.BBANK_BIAS PARAM_VALUE.CP } {
	...
	set values(CP) [get_property value $CP]
	set_property value [gen_USERPARAMETER_BRAM_N_VALUE $values(VER_DPU_NUM) $values(BBANK_IMG_N) $values(BBANK_WGT_N) $values(BBANK_BIAS) $values(CP)] $BRAM_N
}
...
proc update_PARAM_VALUE.CONV_RELU_ADDON { PARAM_VALUE.CONV_RELU_ADDON PARAM_VALUE.DWCV_ENA } {
	...
	set DWCV_ENA ${PARAM_VALUE.DWCV_ENA}
	set values(DWCV_ENA) [get_property value $DWCV_ENA]
	set_property value [gen_USERPARAMETER_CONV_RELU_ADDON_VALUE $values(DWCV_ENA)] $CONV_RELU_ADDON
}
...
proc update_PARAM_VALUE.DSP_NUM { PARAM_VALUE.DSP_NUM PARAM_VALUE.LOAD_DSP_NUM PARAM_VALUE.CONV_DSP_NUM PARAM_VALUE.DWCV_DSP_NUM PARAM_VALUE.VER_DPU_NUM } {
	...
	set values(VER_DPU_NUM) [get_property value $VER_DPU_NUM]
	set_property value [gen_USERPARAMETER_DSP_NUM_VALUE $values(LOAD_DSP_NUM) $values(CONV_DSP_NUM) $values(DWCV_DSP_NUM) $values(VER_DPU_NUM)] $DSP_NUM
}
...
proc update_PARAM_VALUE.IBGRP_N { PARAM_VALUE.IBGRP_N PARAM_VALUE.DWCV_ENA } {
	# Procedure called to update IBGRP_N when any of the dependent parameters in the arguments change
	
	set IBGRP_N ${PARAM_VALUE.IBGRP_N}
	set DWCV_ENA ${PARAM_VALUE.DWCV_ENA}
	set values(DWCV_ENA) [get_property value $DWCV_ENA]
	set_property value [gen_USERPARAMETER_IBGRP_N_VALUE $values(DWCV_ENA)] $IBGRP_N
}
...
proc update_PARAM_VALUE.IRQ_SUM { PARAM_VALUE.IRQ_SUM PARAM_VALUE.VER_DPU_NUM } {
	...
	set VER_DPU_NUM ${PARAM_VALUE.VER_DPU_NUM}
	set values(VER_DPU_NUM) [get_property value $VER_DPU_NUM]
	set_property value [gen_USERPARAMETER_IRQ_SUM_VALUE $values(VER_DPU_NUM)] $IRQ_SUM
}
...
proc update_MODELPARAM_VALUE.IBGRP_N { MODELPARAM_VALUE.IBGRP_N PARAM_VALUE.IBGRP_N PARAM_VALUE.DWCV_ENA } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	
	set IBGRP_N ${PARAM_VALUE.IBGRP_N}
	set DWCV_ENA ${PARAM_VALUE.DWCV_ENA}
	set values(DWCV_ENA) [get_property value $DWCV_ENA]
	set_property value [gen_HDLPARAMETER_IBGRP_N_VALUE $values(DWCV_ENA)] $IBGRP_N
}
...
proc update_MODELPARAM_VALUE.CONV_RELU_ADDON { MODELPARAM_VALUE.CONV_RELU_ADDON PARAM_VALUE.CONV_RELU_ADDON PARAM_VALUE.DWCV_ENA } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	
	set CONV_RELU_ADDON ${PARAM_VALUE.CONV_RELU_ADDON}
	set DWCV_ENA ${PARAM_VALUE.DWCV_ENA}
	set values(DWCV_ENA) [get_property value $DWCV_ENA]
	set_property value [gen_HDLPARAMETER_CONV_RELU_ADDON_VALUE $values(DWCV_ENA)] $CONV_RELU_ADDON
}
