...
set genomeRtd $env(RT_TMP)/23273518.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {m_ebdeca33__GB3}]"
...
set genomeName [subst -nocommands -novariables {m_ebdeca33__GB3}]
