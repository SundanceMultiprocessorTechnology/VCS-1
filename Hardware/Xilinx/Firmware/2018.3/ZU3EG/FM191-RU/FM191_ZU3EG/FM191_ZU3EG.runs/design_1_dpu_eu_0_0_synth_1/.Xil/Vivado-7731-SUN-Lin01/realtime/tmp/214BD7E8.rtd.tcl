...
set genomeRtd $env(RT_TMP)/214BD7E8.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {m_d9901747__GC0}]"
...
set genomeName [subst -nocommands -novariables {m_d9901747__GC0}]
