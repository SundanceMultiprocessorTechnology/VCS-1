...
set genomeRtd $env(RT_TMP)/1FDB8510.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {m_ebdeca33__GB0}]"
...
set genomeName [subst -nocommands -novariables {m_ebdeca33__GB0}]
