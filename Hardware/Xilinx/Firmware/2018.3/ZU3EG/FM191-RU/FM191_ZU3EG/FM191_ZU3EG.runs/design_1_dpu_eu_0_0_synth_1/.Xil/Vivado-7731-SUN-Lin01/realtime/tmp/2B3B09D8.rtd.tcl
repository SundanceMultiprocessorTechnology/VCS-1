...
set genomeRtd $env(RT_TMP)/2B3B09D8.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {m_ebdeca33__GB2}]"
...
set genomeName [subst -nocommands -novariables {m_ebdeca33__GB2}]
