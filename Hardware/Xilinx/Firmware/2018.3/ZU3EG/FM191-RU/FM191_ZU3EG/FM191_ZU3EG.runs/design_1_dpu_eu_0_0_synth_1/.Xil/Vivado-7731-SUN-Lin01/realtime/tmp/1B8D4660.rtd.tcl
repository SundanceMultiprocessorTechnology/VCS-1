...
set genomeRtd $env(RT_TMP)/1B8D4660.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {m_d88e4a0b__GCB2}]"
...
set genomeName [subst -nocommands -novariables {m_d88e4a0b__GCB2}]
